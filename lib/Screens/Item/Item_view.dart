              ...
              children: [
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        // fit: BoxFit.cover,  width: MediaQuery.of(context).size.width - 16,
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      TextThemes.H2itle(
                          "Rs ${model.item!.price}", Themes.keyDark, 1),
                      Row(
                        children: [
                          InkWell(
                            onTap: () => model.changeCount(
                                context: context, isIncrease: false),
                            child: Icon(
                          ...
                          TextThemes.H2itle(
                              model.itemCount.toString(), Themes.keyDark, 1),
                          const SizedBox(
                            width: 8.0,
                          ),
                          InkWell(
                            onTap: () => model.changeCount(
                                context: context, isIncrease: true),
                            child: Icon(
                ...
                SizedBox(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(left: 8.0, right: 8.0),
                    child: TextThemes.subtitle(
                        model.item!.description, Themes.shadwoAsh, 8,
                          ...
                          child: InkWell(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                TextThemes.boldtitle(
                                    model.item!.unitType![index].value,
                                    Themes.keyDark,
                                    1,
                                    textAlign: TextAlign.start),
                                const SizedBox(
                                ...
                                TextThemes.boldtitle(
                                    "Rs.${model.item!.unitType![index].price}",
                                    Themes.shadwoAsh,
                                    1,
                                    textAlign: TextAlign.start),
